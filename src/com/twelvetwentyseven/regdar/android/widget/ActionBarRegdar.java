...
import com.twelvetwentyseven.regdar.android.client.R.id;
import com.twelvetwentyseven.regdar.android.client.R.layout;
import com.twelvetwentyseven.regdar.android.client.R.string;
import com.twelvetwentyseven.regdar.android.client.R.styleable;
...
public class ActionBarRegdar extends RelativeLayout implements OnClickListener {
    ...
    public ActionBarRegdar(Context context, AttributeSet attrs) {
        super(context, attrs);

        mInflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);

        mBarView = (RelativeLayout) mInflater.inflate(R.layout.action_bar_regdar, null);
        addView(mBarView);
